...
public class CreationContactController {
    ...
    private boolean delOneContact(int id) throws IOException, ClassNotFoundException {
        ...
        CreationContactController.setId(0);
    ...
    public boolean persistContact() throws ClassNotFoundException, IOException {
        ...
        if (!error) {
            ...
            // if edit
                ...
                // ContactDAO contactToEdit = ContactDAO.findContactById(id);
