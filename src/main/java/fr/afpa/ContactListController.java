...
public class ContactListController {
    ...
    public void initialize() throws ClassNotFoundException, IOException {
        ...
        this.diplaySearchResult(contactDAO.getAllContacts());
    ...
    public void exportAllSelected(String type) throws ClassNotFoundException, IOException {
        ...
        for (CheckBox checkBox : this.checkBoxes) {
            if (checkBox.isSelected()) {
                int id = (int) checkBox.getProperties().get("id");
                ContactDAO contactDAO = new ContactDAO();
    ...
    public void exportOneJson(ActionEvent event) throws ClassNotFoundException, IOException {
        this.exportOne("json", (Integer) ((Button) event.getSource()).getProperties().get("id"));
    }

    public void exportOneVcf(ActionEvent event) throws ClassNotFoundException, IOException {
        this.exportOne("vcf", (Integer) ((Button) event.getSource()).getProperties().get("id"));
    }

    // export the contacts in the argument type
    public void exportOne(String type, int id) throws ClassNotFoundException, IOException {
        DAO<Contact> contactDAO = new ContactDAO();
        Contact contactToExport = contactDAO.get(id);
        // get the right serializer
        var serializer = (type.equals("json")) ? Contact.JSON_SERIALIAZER : Contact.V_CARD_SERIALIZER;
...
public void deleteAllSelected() throws ClassNotFoundException, IOException {
    ...
    public boolean redirectToEdit(int id) throws IOException {
    ...
    public boolean diplaySearchResult(List<Contact> contacts){
