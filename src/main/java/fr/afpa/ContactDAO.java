...
public class ContactDAO extends DAO<Contact> {
    ...
    public Contact get(int id) {
        ...
        try {
            ...
            try (ResultSet result = pstmt.executeQuery()) {
                if (result.next()) {
                    LocalDate birthdate = result.getDate("birth_date").toLocalDate(); // Initialisation de la variable birthdate
                    ...
                    return new Contact(
                            ...
                            birthdate, // Utilisation de la variable birthdate
    ...
    public List<Contact> getAllContacts() {
        ...
        try {
            ...
            while (result.next()) {
                // Récupérer la date en tant que LocalDate
                LocalDate birthdate = (result.getDate("birth_date") != null ) ?  result.getDate("birth_date").toLocalDate() : null;

                // Créer l'objet Contact avec le type approprié pour birthdate
...
//                            result.getString("first_name"),
//                            result.getString("gender"),
//                            String.valueOf(result.getObject("birth_date", LocalDate.class)),
//                            result.getString("pseudo"),
//                            result.getString("personnal_number"),
//                            result.getString("professionnal_number"),
//                            result.getString("mail_adress"),
...
//    }
    ...
    public static ContactDAO findContactById(int id) {
